      ...
      <div class="py-container">
        ...
        <div class="bread">
          ...
          <ul class="fl sui-tag">
            ...
            >
              {{ attrValue.split(":")[1] }}
              <i @click="removeAttralue(index)">x</i>
            </li>
          </ul>
        </div>
...
export default {
  ...
  methods: {
    ...
    changeOrder(flag) {
      ...
      let originOrder = this.searchParams.order; //获取初始参数
      ...
      if (flag == originFlag) {
        ...
        newOrder = `${originFlag}:${originSort == "desc" ? "asc" : "desc"}`; //三元表达式+模版字符串
      } else {
        newOrder = `${flag}:${"asc"}`;
      }
